...
class Lyric{
  ...
  Lyric(this.lyric, {required this.startTime, this.endTime, this.offset});
...
class LyricData {
  ...
  factory LyricData.fromJson(jsonRes) {
    if (jsonRes == null) {
      throw "Invalid jsonRes";
    } 
    ...
    return LyricData(
      ...
      lyric: Klyric.fromJson(jsonRes['klyric']),
...
class TransUser {
  ...
  factory TransUser.fromJson(jsonRes) {
    if (jsonRes == null) {
      throw "Invalid jsonRes";
    } 
...
class LyricUser {
  ...
  factory LyricUser.fromJson(jsonRes) {
    if (jsonRes == null) {
      throw "Invalid jsonRes";
    } 
...
class Klyric {
  ...
  factory Klyric.fromJson(jsonRes) {
    if (jsonRes == null) {
      throw "Invalid jsonRes";
    } 
    ...
    return  Klyric(
      ...
      lyric:
          convertValueByType(jsonRes['lyric'], String, stack: "Klyric-lyric"),
    );
  }
...
class Tlyric {
  ...
  factory Tlyric.fromJson(jsonRes){
    if (jsonRes == null) {
      throw "Invalid jsonRes";
    } 
