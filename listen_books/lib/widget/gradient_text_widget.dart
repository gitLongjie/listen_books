...
import 'package:listen_books/model/color_provider.dart';
...
class GradientText extends StatefulWidget {
  ...
  GradientText({required this.text, this.offsetX = 0.0, this.colorBg = Colors.white});

  @override
  State<StatefulWidget> createState() => _GradientTextState();
